...
# Para Supabase, necesitas estos valores:
# SUPABASE_HOST: de tu panel de Supabase -> Settings -> Database -> Host
# SUPABASE_PASSWORD: la contraseña que configuraste al crear el proyecto
# El formato del host es: db.PROJECT_REF.supabase.co

SUPABASE_HOST = os.environ.get("SUPABASE_HOST", "aws-1-eu-west-1.pooler.supabase.com")
SUPABASE_PASSWORD = os.environ.get("SUPABASE_PASSWORD", "dgqOwM4Z56n9Ljvo")
SUPABASE_USER = os.environ.get("SUPABASE_USER", "postgres.vngciwggflrlpzgkylmx")
...
def get_db_connection():
    ...
    try:
        conn = psycopg2.connect(
            ...
            host=SUPABASE_HOST,
            port=SUPABASE_PORT,
            sslmode='require'  # IMPORTANTE: Supabase requiere SSL
        )
